...
var _user$project$Main$onFloatInput = function (toMsg) {
	return A2(
		_elm_lang$html$Html_Events$on,
		'input',
		A2(
...
var _user$project$Main$leafletMap = _elm_lang$html$Html$node('leaflet-map');
...
var _user$project$Main$init = {
	ctor: '_Tuple2',
	_0: {latitude: 48.2082, longitude: 16.3738, zoom: '5'},
	_1: _elm_lang$core$Platform_Cmd$none
};
var _user$project$Main$Model = F3(
	function (a, b, c) {
		return {latitude: a, longitude: b, zoom: c};
	});
var _user$project$Main$SetZoom = function (a) {
	return {ctor: 'SetZoom', _0: a};
};
					...
					_1: {
						...
						_0: A2(
							_elm_lang$html$Html$input,
							{
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$min('-1800000'),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$max('1800000'),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$value(
												_elm_lang$core$Basics$toString(model.latitude * 10000)),
											_1: {
												ctor: '::',
												_0: _user$project$Main$onFloatInput(_user$project$Main$SetLatitude),
												_1: {ctor: '[]'}
											}
										}
									}
									...
									_1: {
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$value(
													_elm_lang$core$Basics$toString(model.longitude * 10000)),
												_1: {
													ctor: '::',
													_0: _user$project$Main$onFloatInput(_user$project$Main$SetLongitude),
													_1: {ctor: '[]'}
												}
											}
										}
							...
							_1: {
									...
									_elm_lang$html$Html$input,
									{
										...
										_1: {
											...
											_1: {
												...
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$value(model.zoom),
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Events$onInput(_user$project$Main$SetZoom),
														_1: {ctor: '[]'}
													}
												}
											}
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text(model.zoom),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
							...
							_0: A2(
								_user$project$Main$leafletMap,
								{
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: A2(_elm_lang$html$Html_Attributes$attribute, 'zoom', model.zoom),
											_1: {
												ctor: '::',
												_0: A2(
													_elm_lang$html$Html_Events$on,
												...
												_1: {
													...
													_0: A2(
														...
														A2(
															_elm_lang$core$Json_Decode$map,
															function (_p2) {
																return _user$project$Main$SetZoom(
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Main.Msg":{"args":[],"tags":{"SetLatitude":["Float"],"SetLatLong":["Float","Float"],"SetZoom":["String"],"SetLongitude":["Float"]}}},"aliases":{},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
